...
<body>
    ...
    <div id="page_content">
        ...
        ?>
                ...
                <strong style="font-size: 20px;" > 匯入到 " <?php echo htmlspecialchars($subdir); ?>" 資料庫</strong>
            <?php
            }
        endforeach;
        ?>
        <div>
            <form id="importForm" action="import.php" method="post" enctype="multipart/form-data">
                ...
                <label for="input_import_file">由電腦上傳:</label>
                <input type="file" id="input_import_file" name="input_import_file" accept=".csv, .xls, .xlsx">
                ...
                <input type="hidden" name="selectedDatabase" value="<?php echo htmlspecialchars($subdir); ?>">
